...
public class RegisterService extends CoreWebService implements Runnable {
    ...
    public RegisterService(String url, ServiceCallback serviceCallback) {
        super(url);
