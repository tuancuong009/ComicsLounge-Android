...
public class EditProfileService extends CoreWebService implements Runnable {
    public static final String SERVICE_NAME = "EditProfileService";
    ...
    public EditProfileService(String url, ServiceCallback serviceCallback) {
        super(url);
