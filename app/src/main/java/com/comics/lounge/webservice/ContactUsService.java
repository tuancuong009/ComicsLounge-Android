...
public class ContactUsService extends CoreWebService implements Runnable {
    public static final String SERVICE_NAME = "ContactUsService";
    ...
    public ContactUsService(String url, ServiceCallback serviceCallback) {
        super(url);
