...
public class OtpVerifyService extends CoreWebService implements Runnable {
    public static final String SERVICE_NAME = "OtpVerifyService";
    ...
    public OtpVerifyService(String url, ServiceCallback serviceCallback) {
        super(url);
    ...
    public void run() {
        ...
        try {
            ...
            getResponse();
            Log.e("OTP_SCREEN::", getLastResponse());
    ...
    //{    "otp_status": "verified",    "status": "success",    "name": "test1",    "email": "test@test.com",    "country_phone_code": "61",    "phone_number": "8000337566"}
