...
//    private WebViewSuite webView;
    ...
    public static TermsAndConditionFragment newInstant(boolean hideToolbar) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.tems_con_fragment, container, false);
    }
...
//        webView = view.findViewById(R.id.webViewSuite);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        toolbarNameTxt.setText(getResources().getString(R.string.terms_condition_str));

        if (parentActivity != null) menuIcon.setOnClickListener(v -> parentActivity.openDrawer());

//        webView.setCustomProgressBar(progressBar);
//        webView.startLoading(UrlCollection.TEMS_CON_URL);
    }
